...
pub fn BotSelector() -> impl IntoView {
    ...
    let selected_bots = use_context::<ReadSignal<Vec<usize>>>().expect("missing `selected_bots` context");
    let set_selected_bots = use_context::<WriteSignal<Vec<usize>>>().expect("missing `set_selected_bots` context");

    view! {
        <div class="p-6">
            <h2 class="text-lg font-bold text-center text-gray-200 mb-4 drop-shadow-lg">
                "Choose your bots"
            </h2>
